...
/**
 * Jane App webhook / bridge for confirmed bookings.
 *
 * Jane App (clinics/wellness) has a Developer Platform; webhooks may be available with extension approval.
 * Until then, use this endpoint from Make/Zapier or a polling job that uses Jane's API.
 *
 * POST /api/webhooks/jane?business_id=<BUSINESS_UUID>
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error("[webhooks/jane] unexpected error:", e);
    return NextResponse.json(
