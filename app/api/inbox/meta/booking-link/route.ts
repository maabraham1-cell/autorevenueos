...
const LOG_PREFIX = "[inbox/meta/booking-link]";
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!attributed) {
      ...
      return NextResponse.json({ error: "Failed to build booking link" }, { status: 500 });
    }
